...
const counterClaims: (CounterClaim & { id: number })[] = [
    ...
    },
    {
        ...
        summary: {
            en: "Digital workflow for custom hip orthosis design using smartphone photogrammetry for 3D surface reconstruction, manual CAD modeling with Blender software, and 3D printing with FDM technology. Demonstrates feasibility of low-cost approach using photogrammetry compared to laser scanning, with manual design process and rapid prototyping fabrication achieving good fit accuracy on plastic doll model.",
            de: "Digitaler Arbeitsablauf für maßgeschneiderte Hüftorthesen-Design unter Verwendung von Smartphone-Photogrammetrie für 3D-Oberflächenrekonstruktion, manuelle CAD-Modellierung mit Blender-Software und 3D-Druck mit FDM-Technologie. Demonstriert Machbarkeit kostengünstiger Ansatz mit Photogrammetrie im Vergleich zu Laserscanning, mit manuellem Designprozess und Rapid-Prototyping-Fertigung mit guter Passgenauigkeit am Kunststoffpuppen-Modell.",
            fr: "Flux de travail numérique pour conception d'orthèse de hanche personnalisée utilisant photogrammétrie smartphone pour reconstruction 3D, modélisation CAO manuelle avec logiciel Blender et impression 3D avec technologie FDM. Démontre faisabilité d'approche à faible coût utilisant photogrammétrie comparée au balayage laser, avec processus de conception manuelle et fabrication par prototypage rapide atteignant bonne précision d'ajustement sur modèle de poupée plastique.",
            es: "Flujo de trabajo digital para diseño de ortesis de cadera personalizada usando fotogrametría smartphone para reconstrucción 3D, modelado CAD manual con software Blender e impresión 3D con tecnología FDM. Demuestra viabilidad de enfoque de bajo costo usando fotogrametría comparada con escaneo láser, con proceso de diseño manual y fabricación por prototipado rápido logrando buena precisión de ajuste en modelo de muñeca plástica.",
            it: "Flusso di lavoro digitale per progettazione di ortesi dell'anca personalizzata utilizzando fotogrammetria smartphone per ricostruzione 3D, modellazione CAD manuale con software Blender e stampa 3D con tecnologia FDM. Dimostra fattibilità di approccio a basso costo utilizzando fotogrammetria confrontata con scansione laser, con processo di progettazione manuale e fabbricazione tramite prototipazione rapida raggiungendo buona precisione di adattamento su modello di bambola plastica.",
        },
    },
    {
        id: 9,
